...
"""
    ...
    Usage Examples:
        ...
        <dir>
            ...
            <wct>main/updates/0</wct>
        </dir>

        <dir>
            <title>Latest Releases (Full List)</title>
            <wct>wcdaily-updates</wct>
        </dir>

        <dir>
            <title>Popular Series (Short List)</title>
            <wct>main/popular_series/0</wct>
        </dir>

        <dir>
            <title>Popular Series (Full List)</title>
            <wct>popular-cartoon</wct>
        </dir>

        <dir>
            <title>Cartoons</title>
            <wct>category/cartoon</wct>
        </dir>

        <dir>
            <title>Movies</title>
            <wct>category/movies</wct>
        </dir>
        ...
        <dir>
            ...
            <wct>wcsearch/101 dalmatians</wct>
        </dir>
...
class WatchCart(Plugin):
    name = "wct"

    def process_item(self, item_xml):
        if "<wct>" in item_xml:
            item = JenItem(item_xml)
            if "wctepisode/" in item.get("wct", ""):
                result_item = {
                    'label': item["title"],
            ...
            elif "wctsearch" in item.get("wct", ""):
                result_item = {
                    'label': item["title"],
                    'icon': item.get("thumbnail", addon_icon),
                    'fanart': item.get("fanart", addon_fanart),
            ...
            elif "list-videos/" in item.get("wct", ""):
                result_item = {
                    'label': item["title"],
                    'icon': item.get("thumbnail", addon_icon),
                    'fanart': item.get("fanart", addon_fanart),
            ...
            elif "popular-cartoon" in item.get("wct", ""):
                result_item = {
                    'label': item["title"],
                    'icon': item.get("thumbnail", addon_icon),
                    'fanart': item.get("fanart", addon_fanart),
            ...
            elif "wcdaily-updates" in item.get("wct", ""):
                result_item = {
                    'label': item["title"],
                    'icon': item.get("thumbnail", addon_icon),
                    'fanart': item.get("fanart", addon_fanart),
...
@route(mode='WCTEpisodes', args=["url"])
...
@route(mode='WCTListVideos', args=["url"])
...
@route(mode='WCTPlayVideo', args=["url"])
